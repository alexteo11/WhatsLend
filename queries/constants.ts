export enum QUERY_KEY {
  ...
  LenderDashboardDetails = "lender-dashboard-details",
  ...
  AdminGetUsers = "admin-get-users",
  AdminGetUserApplicationHistory = "admin-get-user-application-history",
  AdminGetLenders = "admin-get-lenders",
  AdminGetLenderApplicationOffer = "admin-get-lender-application-offer",
}
