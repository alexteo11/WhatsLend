...
import { useLenderDashboardDetailsQuery } from "@/queries/lender/use-lender-dashboard-details-query";
import { useLenderDashboardSummaryQuery } from "@/queries/lender/use-lender-dashboard-summary-query";
...
const Dashboard = ({ isAdmin }: { isAdmin: boolean }) => {
  ...
  const { data: detailsData, isLoading: isLoadingDetails } = isAdmin
      ...
      <div className="flex flex-col gap-4">
        <div className="flex items-center justify-between">
          <h1 className="lender-page-title">
            {isAdmin ? "Offer Reports" : "Dashboard"}
          </h1>
          <div>
            <DateRangePicker
              date={date}
