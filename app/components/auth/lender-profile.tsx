...
const LenderProfile = ({ lenderId }: { lenderId: string }) => {
    ...
    <div className="flex flex-col gap-4">
      ...
      >
        <div className="min-w-[450px] p-10">
          <h1 className="mb-10 text-center text-2xl text-app">All Employees</h1>
          <EmployeesDetails lenderStaffs={data?.staffs || []} />
        </div>
      </BaseDialog>
...
const LoanCriteriaDialog = ({
  ...
  return (
    ...
    >
      <LoaderWrapper isLoading={isSubmitting} isContainer>
        <div className="min-w-[450px] max-w-[600px] p-10">
          ...
          <div className="mt-8 flex flex-col gap-8">
            <Form {...loanCriteriaForm}>
              ...
              >
                <LoanCriteria form={loanCriteriaForm} />
                <div className="flex flex-row justify-end gap-4">
                  <Button
                    variant="outline"
                    type="button"
